...
from src.experiments.exp3_ablation_study import (
    CONDITIONS,
    DEFAULT_ABLATION_PROMPT_VERSION,
...
class Exp3ProtocolTests(unittest.TestCase):
    ...
    def test_cli_defaults_to_scores_only_v18_prompt(self) -> None:
        args = build_parser().parse_args([])
        self.assertEqual(args.prompt_version, DEFAULT_ABLATION_PROMPT_VERSION)
        self.assertEqual(args.prompt_version, "v18_reflective_grounding_scores_only")
