...
# All three ablation tracks run the result-audited V18 response prompt with the
# previous-turn state restricted to the three empathy scores. Override per run
# with --prompt-version if a different generation baseline is needed.
DEFAULT_ABLATION_PROMPT_VERSION = "v18_reflective_grounding_scores_only"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=DEFAULT_ABLATION_PROMPT_VERSION,
    )
    parser.add_argument(
